...
#[derive(Debug)]
pub struct Triple<'a>(&'a Card, &'a Card, &'a Card);
...
pub fn find_set(cards: Vec<&Card>) -> Result<Triple, SetError> {
...
pub fn find_all_sets(cards: Vec<&Card>) -> Vec<Triple> {
